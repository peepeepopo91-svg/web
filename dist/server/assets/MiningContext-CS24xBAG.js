...
import { E as EXCHANGE_CONSTANTS, M as MINING_CONSTANTS, d as getCommunityState, a as getExchangeRate, n as normalizeUser, c as catchUpUser, s as saveUser, e as saveCommunityState, f as getUser, h as createUser, i as setCurrentUsername, b as buyRig, j as startMining, k as stopMining, r as repairRig, l as sellRig, m as exchangeBCForGems, o as exchangeGemsForBC, p as getCurrentUsername, q as saveEconomyOverrides } from "./miningStore-vSM2TBEv.js";
import { c as createSsrRpc } from "./router-BF68vAiv.js";
import { z } from "zod";
import { c as createServerFn } from "../server.js";
import { s as saveMiningUser, b as serverCatchUp, p as purchaseRigServer, r as renewMiningSession, c as getEconomyConfig } from "./miningServer-sUErK4QF.js";
z.object({
...
function MiningProvider({ children }) {
  ...
  function applyServerResult(result) {
    ...
    if (result.economy && Object.keys(result.economy).length > 0) {
      saveEconomyOverrides(result.economy, { silent: true });
    }
      ...
      if (username) {
        ...
        try {
          ...
          if (economy && Object.keys(economy).length > 0) {
            saveEconomyOverrides(economy, { silent: true });
          }
        } catch {
        }
        const now = Date.now();
