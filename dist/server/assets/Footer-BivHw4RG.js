    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-white/[0.06] flex-shrink-0", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xl", children: icon }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsx("h2", { className: "text-white font-black text-lg leading-none", children: title }),
                /* @__PURE__ */ jsx("p", { className: "text-white/30 text-[11px] mt-0.5", children: "Blue Tiers — Last updated July 2025" })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-y-auto flex-1 px-6 py-5 space-y-6", children: sections.map((s) => /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-[#00BFFF] font-bold text-[13px] mb-2", children: s.heading }),
              /* @__PURE__ */ jsx("p", { className: "text-white/55 text-[13px] leading-relaxed", children: s.body })
            ] }, s.heading)) }),
            /* @__PURE__ */ jsxs("div", { className: "px-6 py-3 border-t border-white/[0.05] flex items-center justify-between flex-shrink-0", children: [
              /* @__PURE__ */ jsx("span", { className: "text-white/20 text-[11px]", children: "© 2025 Blue Tiers. All rights reserved." }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: onClose,
...
function XIcon({ size = 20 }) {
  return /* @__PURE__ */ jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.259 5.631 5.905-5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z" }) });
}
function TikTokIcon({ size = 20 }) {
  return /* @__PURE__ */ jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.17 8.17 0 0 0 4.78 1.52V6.77a4.85 4.85 0 0 1-1.01-.08z" }) });
}
function YouTubeIcon({ size = 20 }) {
  return /* @__PURE__ */ jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" }) });
}
function Footer() {
  ...
  cfg.footer.columns.some((col) => col.links.some((l) => l.url === "/admin"));
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(LegalModal, { doc: legalDoc, onClose: () => setLegalDoc(null) }),
    /* @__PURE__ */ jsxs("footer", { className: "relative bg-black border-t border-[#111111] overflow-hidden", children: [
      cfg.footer.showWatermark && /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs(
            "svg",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("mask", { id: "footerSwordMask", children: [
                  /* @__PURE__ */ jsx("rect", { width: "24", height: "24", fill: "white" }),
                  /* @__PURE__ */ jsx("polygon", { points: "3,3 6,3 17.5,14.5 14.5,17.5 3,6", fill: "black" })
                ] }) }),
                /* @__PURE__ */ jsxs("g", { mask: "url(#footerSwordMask)", children: [
                  /* @__PURE__ */ jsx("polyline", { points: "9.5 17.5 21 6 21 3 18 3 6.5 14.5" }),
                  /* @__PURE__ */ jsx("line", { x1: "11", y1: "19", x2: "5", y2: "13" }),
                  /* @__PURE__ */ jsx("line", { x1: "8", y1: "16", x2: "4", y2: "20" }),
                  /* @__PURE__ */ jsx("line", { x1: "5", y1: "21", x2: "3", y2: "19" })
                ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative max-w-6xl mx-auto px-8 py-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-8", children: [
          (() => {
            const nav = visibleColumns.find((c) => c.title.toLowerCase() === "navigate");
            if (!nav) return null;
            return /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "mb-5 uppercase tracking-widest text-xs font-semibold", style: { background: "linear-gradient(90deg, #00BFFF, #0099FF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }, children: "navigate" }),
              /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: nav.links.map((link, li) => /* @__PURE__ */ jsx("li", { children: link.internal ? /* @__PURE__ */ jsx(
                Link,
                {
                  to: link.url,
          ...
          (() => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
              /* @__PURE__ */ jsx("p", { className: "mb-5 uppercase tracking-widest text-xs font-semibold", style: { background: "linear-gradient(90deg, #00BFFF, #0099FF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }, children: "social" }),
              discord && /* @__PURE__ */ jsxs(
                "a",
                {
                  href: discord.url,
                  target: "_blank",
                  ...
                  style: { color: "#fff" },
                  children: [
                    /* @__PURE__ */ jsx(DiscordIcon, { size: 32 }),
                    /* @__PURE__ */ jsx("span", { className: "text-2xl font-semibold tracking-wider", children: "DISCORD" })
                  ]
                }
              ),
              others.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-5", children: others.map((link, i) => {
                ...
                return /* @__PURE__ */ jsxs(
                  "a",
                  {
                    ...
                    style: { color: "#fff" },
                    children: [
                      platform === "x" && /* @__PURE__ */ jsx(XIcon, { size: 20 }),
                      platform === "tiktok" && /* @__PURE__ */ jsx(TikTokIcon, { size: 20 }),
                      platform === "youtube" && /* @__PURE__ */ jsx(YouTubeIcon, { size: 20 })
                    ]
                  },
                  i
                );
          ...
          (() => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end text-right", children: [
              /* @__PURE__ */ jsx("p", { className: "mb-5 uppercase tracking-widest text-xs font-semibold", style: { background: "linear-gradient(90deg, #00BFFF, #0099FF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }, children: "legal" }),
              /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: legal.links.map((link, li) => {
                if (link.internal && ["terms", "privacy", "screenshare"].includes(link.url)) {
                  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: () => setLegalDoc(link.url),
                ...
                return /* @__PURE__ */ jsx("li", { children: link.internal ? /* @__PURE__ */ jsx(
                  Link,
                  {
                    to: link.url,
                    className: "text-sm transition-colors duration-150",
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs", style: { color: "#333" }, children: cfg.footer.copyright }),
              cfg.footer.tagline && /* @__PURE__ */ jsx("span", { className: "text-xs", style: { color: "#333" }, children: cfg.footer.tagline })
            ]
          }
        )
      ] })
