...
import { c as scheduleBackup } from "./miningBackup-C2ru7u1S.js";
...
import "./github-CKcpqj8A.js";
import "./tokenStore-Dpx2yaa_.js";
import "./repoConfigUtil-DmRyhrlE.js";
...
const getEconomyConfig_createServerFn_handler = createServerRpc({
  id: "09ab9a99c03428f041005f7ff3c91460b1fdb4575960c02120a4e5ff70f520da",
  name: "getEconomyConfig",
  filename: "src/server/miningServer.ts"
}, (opts) => getEconomyConfig.__executeServer(opts));
const getEconomyConfig = createServerFn({
  method: "GET"
}).handler(getEconomyConfig_createServerFn_handler, async () => {
...
export {
  ...
  getEconomyConfig_createServerFn_handler,
